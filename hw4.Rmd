...
When additional costs for Policy B <  \$ $2.24 \times 10^{15}$, then Policy B is cheaper and it would be cheaper. When the additional costs > \$ $2.24 \times 10^{15}$, then policy A is cheaper and it would be chosen. 
